...
(function ($, document) {
  ...
  function setItems(items){
  	$.jStorage.set(PRODUCTS_KEY,items);

  	return true;
  }

  function setItem(id,atribute,value){
  	var items = getItems();
  	if (id in items){
      items[id][atribute]=value;
    } 
  	$.jStorage.set(PRODUCTS_KEY,items);
  ...
  $.extend( CestaFeira.prototype, {
    ...
    setItem:     	function(id,atribute,value){ return setItem(id,atribute,value); },
